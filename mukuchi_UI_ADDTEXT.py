...
charac="小鳐"
picai="xiaoyao.png"
apikey="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"
...
class MukuchiChatDemo(QWidget):
    ...
    def __init__(self,parent=None):
        ...
        self.update_api_button.clicked.connect(self.main_sys.update_api)
        self.update_api_button.setGeometry(10, 460, 80, 30)

        self.save_button = QPushButton('保存', self)
        #self.save_button.clicked.connect(self.controller.save_chat_history)
        self.save_button.setGeometry(100, 460, 80, 30)

        self.log_button = QPushButton('日志', self)
        #self.log_button.clicked.connect(self.controller.toggle_log)
    ...
    def initUI(self):
        ...
        self.btnPress1.setGeometry(295,410,40,40)#发送
    ...
    def set_palette(self):
        ...
        palette.setBrush(self.backgroundRole(), QBrush(QPixmap('test.png').scaled(350, 502)))
